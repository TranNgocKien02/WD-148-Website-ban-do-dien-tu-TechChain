            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="header-top-left">
                        <ul class="phone-wrap">
                            <li><span>Số điện thoại liên hệ:</span><a href="#"></a></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="logo pb-sm-30 pb-xs-30">
                        <a href="{{route('index')}}">
                            <img src="{{asset('assets/client/img/logo/1.jpg')}}" alt="">
                        </a>
                    </div>
                </div>
                                ...
                                <div class="minicart">
                                                    ...
                                                    <div class="minicart-product-details">
                                                        ...
                                                        <span>
                                                            @if (isset($item->productVariant->sanpham->gia_khuyen_mai) && $item->productVariant->sanpham->gia_khuyen_mai > 0)
                                                                <del>
                                                                    <span
                                                                        class="text-decoration-line-through">{{ number_format($item->productVariant->sanpham->gia_san_pham, 0, '', '.') }}VND</span>
                                                                </del>
                                                                <br>
                                                                <span
                                                                    class="text-success">{{ number_format($item->productVariant->sanpham->gia_khuyen_mai, 0, '', '.') }}VND</span>
                                                            @else
                                    ...
                                    <div class="minicart-button">
                                        <a href="{{ route('cart-full.list') }}"
                                            ...
                                            <span>Toàn Bộ Giỏ Hàng</span>
                                        </a>
                                        <a href="{{ route('fulldonhangs.create') }}"
                        ...
                        <nav style="display: block;">
                            <ul>
                                ...
                                <li class="megamenu-holder">
                                    <a href="{{ route('filter') }}">Cửa Hàng</a>
                                    <ul class="megamenu hb-megamenu">
                                        @foreach ($danhMuc as $item)
                                            <li>
                                                <a
                                                    href="{{ route('filter', ['categories' => $item->id]) }}">{{ $item->ten_danh_muc }}</a>
                                                <ul>
                                                    @foreach ($item->hangs as $hang)
                                                        <li>
                                                            <a
                                                                href="{{ route('filter', ['brands' => $hang->id]) }}">{{ $hang->ten_hang }}</a>
                                                        </li>
                                                    @endforeach
                                                </ul>
                                            </li>
