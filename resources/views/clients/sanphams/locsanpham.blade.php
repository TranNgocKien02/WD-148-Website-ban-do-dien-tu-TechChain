                                                    ...
                                                    <div class="product_desc">
                                                        <div class="product_desc_info">
                                                            <div class="product-review">
                                                                ...
                                                                <div class="rating-box">
                                                                    <ul class="rating">
                                                                        ...
                                                                        @for ($i = 0; $i < 5; $i++)
                                                                            <li><i
                                                                                    class="fa {{ $i < $sanPham->rating ? 'fa-star' : 'fa-star-o' }}"></i>
                                                                            </li>
                                                                        @endfor
                                                                    </ul>
                                                                </div>
                                                            ...
                                                            <h4><a class="product_name"
                                                                    href="{{ route('product-detail', $sanPham->slug) }}">{{ $sanPham->ten_san_pham }}</a>
                                                            </h4>
                                                            <div class="price-box">
                                                        ...
                                                        <div class="add-actions">
                                                            <ul class="add-actions-link">
                                                                ...
                                                                <li><a href="{{ route('product-detail', $sanPham->slug) }}"
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="shop-add-action mb-xs-30">
                                                        <ul class="add-actions-link">
                                                            ...
                                                            <li class="wishlist">
                                                                <form id="wishlist-form-{{ $sanPham->id }}"
                                                                    action="{{ route('wishlist.add', $sanPham->id) }}"
                                                                    method="POST" style="display: none;">
                                                                    @csrf
                                                                </form>
                                                                <a href="javascript:void(0);" onclick="document.getElementById('wishlist-form-{{ $sanPham->id }}').submit();">
                                                            ...
                                                            <li>
                                                                <a class="quick-view"
                                                                    href="{{ route('product-detail', $sanPham->slug) }}">
