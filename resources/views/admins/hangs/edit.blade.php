            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admins.hangs.update', $hang->id) }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    @error('ten_hang') is-invalid @enderror"
                                                value="{{ $hang->ten_hang }}" placeholder="Tên danh mục">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="mo_ta" id="mo_ta" cols="30" rows="10"
                                                class="form-control 
                                    @error('mo_ta') is-invalid @enderror"
                                                value="{{ old('mo_ta') }}" placeholder="Nội dung" value="{{ $hang->mo_ta }}"></textarea>
                                ...
                                @error('danh_muc_id') is-invalid @enderror"
                                                value="{{ old('danh_muc_id') }}" placeholder="Danh mục">
                                                @foreach ($listDanhMuc as $index => $danhMuc)
                                                    <option value="{{ $danhMuc->id }}"
                                                        {{ $hang->danh_muc_id == $danhMuc->id ? 'selected' : '' }}>
