...
@section('content')
    ...
    <div class="fxt-form">
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="form-group">
                <div class="fxt-transformY-50 fxt-transition-delay-2">
                    <input id="password-confirm" type="password" class="form-control" name="password_confirmation" placeholder="********" required="required" value="{{ old('password') }}">
                    <i toggle="#password" class="fa fa-fw fa-eye toggle-password field-icon"></i>
                    @error('password')
                    <p class="text-danger">{{ $message }}</p>
                  @enderror
                                ...
                                <div id="qoutescarouselIndicators" class="carousel slide" data-bs-ride="carousel">
                                    ...
                                    <div class="carousel-inner text-center text-white-50 pb-5">
                                        <div class="carousel-item active">
                                            <p class="fs-15 fst-italic">" Chào buổi sáng! Khám phá những thiết bị công nghệ
                                                tuyệt vời nhất ngay hôm nay tại TechChain. "</p>
                                        </div>
                                        <div class="carousel-item">
                                            <p class="fs-15 fst-italic">" Thư giãn cùng TechChain - Đừng bỏ lỡ những ưu đãi
                                                đặc biệt chỉ có hôm nay!."</p>
                                        </div>
                                        <div class="carousel-item">
                                            <p class="fs-15 fst-italic">" Không gian yên tĩnh, thời điểm hoàn hảo để chọn
                                                sản phẩm ưng ý tại TechChain! "</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- end carousel -->
                            ...
                            <form class="needs-validation" novalidate action="{{ route('register') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" name="email" class="form-control" id="useremail"
                                        placeholder="Nhậo địa chỉ email" required value="{{ old('email') }}">
                                    @error('email')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control" id="username"
                                        placeholder="Nhập tên tài khoản" required value="{{ old('name') }}">
                                    @error('name')
                                        <p class="text-danger fs-12 m-0">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="position-relative auth-pass-inputgroup">
                                        <input type="password" name="password_confirmation"
                                            ...
                                            placeholder="Nhập lại mật khẩu " id="password-input"
                                            aria-describedby="passwordInput" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
                                            required>
                                        <button
                                            class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted password-addon material-shadow-none"
                                ...
                                <div class="mb-4">
                                    <p class="mb-0 fs-12 text-muted fst-italic">Bằng cách đăng ký, bạn đồng ý với Điều
                                        khoản sử dụng của E-Smart <br>
                                        <a href="#"
