                                ...
                                <div class="single-product-wrap">
                                    <div class="product-image">
                                        <a href="{{ route('product-detail', ['id' => $sanPham->id]) }}">
                                            <img style="width: 300px; height: 200px; overflow: hidden;" src="{{ Storage::url($sanPham->hinh_anh) }}" alt="product">
                                        </a>
                                    ...
                                    <div class="product_desc">
                                        ...
                                        <div class="add-actions">
                                            <ul class="add-actions-link">
                                                <li class="add-cart active"><a href="{{ route('product-detail', $sanPham->id) }}">Add to cart</a></li>
