                        ...
                        <div class="shop-top-bar mt-30">
                            <div class="shop-bar-inner">
                                ...
                                <div class="toolbar-amount">
                                    <span>Showing {{ $sanPhamHot->firstItem() }} to {{ $sanPhamHot->lastItem() }} of {{ $sanPhamHot->total() }} item(s)</span>
                                </div>
                                                ...
                                                <div class="single-product-wrap">
                                                    ...
                                                    <div class="product_desc">
                                                        <div class="product_desc_info">
                                                            ...
                                                            <h4><a class="product_name" href="{{ route('product-detail', $sanPham->id) }}">{{ $sanPham->ten_san_pham }}</a></h4>
                                                            <div class="price-box">
                                                                <!-- Hiển thị giá sản phẩm -->
                                                                <span class="new-price">${{ $sanPham->gia_khuyen_mai > 0 ? $sanPham->gia_khuyen_mai : $sanPham->gia_san_pham }}</span>
                                                                <!-- Nếu có giá khuyến mãi, có thể hiển thị giá gốc -->
                                                                @if($sanPham->gia_khuyen_mai > 0)
                                                                <span class="old-price">${{ $sanPham->gia_san_pham }}</span>
                                                                @endif
                                                            </div>
                                                        </div>
                                                        <div class="add-actions">
                                                            <ul class="add-actions-link">
                                                                ...
                                                                <li><a href="{{ route('product-detail', $sanPham->id) }}" title="quick view" class="quick-view-btn"><i class="fa fa-eye"></i></a></li>
                                ...
                                <div class="paginatoin-area">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6">
                                            ...
                                            <p>Showing {{ $sanPhamHot->firstItem() }}-{{ $sanPhamHot->lastItem() }} of {{ $sanPhamHot->total() }} item(s)</p>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                    ...
                    <div class="col-lg-3 order-2 order-lg-1">
                        ...
                        <div class="sidebar-categores-box">
                            ...
                            <form action="{{ route('filter') }}" method="GET">
                                <button class="btn-clear-all mb-sm-30 mb-xs-30" type="reset"><a href="{{ route('filter') }}">Clear all</a></button>
                                <!-- Filter by Brand -->
                                <div class="filter-sub-area">
                                    ...
                                    <div class="categori-checkbox">
                                        <ul>
                                            ...
                                            <li>
                                                <input type="checkbox" name="filters[brands][]" value="{{ $brand->id }}"
                                ...
                                <div class="filter-sub-area pt-sm-10 pt-xs-10">
                                    ...
                                    <div class="categori-checkbox">
                                        <ul>
                                            ...
                                            <li>
                                                <input type="checkbox" name="filters[categories][]" value="{{ $category->id }}"
                                ...
                                <div class="filter-sub-area pt-sm-10 pt-xs-10">
                                    ...
                                    <div class="price-range-filter">
                                        ...
                                        <input type="number" id="min-price" name="filters[min_price]" value="{{ request('filters.min_price', 0) }}" placeholder="Min Price">

                                        <label for="max-price">To:</label>
                                        <input type="number" id="max-price" name="filters[max_price]" value="{{ request('filters.max_price', 10000000) }}" placeholder="Max Price">
                                    </div>
                                </div>
                                <!-- filter-sub-area end -->
                                ...
                                <div class="filter-sub-area ">
                                    ...
                                    <div class="categori-checkbox">
                                        <ul>
                                            ...
                                            <li>
                                                <input type="checkbox" name="filters[colors][]" value="{{ $variant->mau_sac }}"
                                ...
                                <div class="filter-sub-area">
                                    ...
                                    <div class="categori-checkbox">
                                        <ul>
                                            ...
                                            <li>
                                                <input type="checkbox" name="filters[capacities][]" value="{{ $variant->dung_luong }}"
                                                    {{ in_array($variant->dung_luong, request('filters.capacities', [])) ? 'checked' : '' }}>
                                                <a href="#">{{ $variant->dung_luong }} GB</a>
                                            </li>
                                            @endforeach
                                        </ul>
                                    </div>
