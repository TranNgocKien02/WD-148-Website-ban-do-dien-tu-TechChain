                ...
                <!-- Product Details Left -->
                    <div class="product-details-left">
                        <div class="product-details-images slider-navigation-1">
                            <div class="lg-image">
                                <a class="popup-img venobox vbox-item" href="{{ asset('lib/images/product/large-size/1.jpg') }}" data-gall="myGallery">
                                    <img src="{{ asset('lib/images/product/large-size/1.jpg') }}" alt="product image">
                                </a>
                            </div>
                            {{-- <div class="lg-image">
                                <a class="popup-img venobox vbox-item" href="{{ asset('lib/images/product/large-size/2.jpg') }}" data-gall="myGallery">
                                    <img src="{{ asset('lib/images/product/large-size/2.jpg') }}" alt="product image">
                                </a>
                            </div>
                            <div class="lg-image">
                                <a class="popup-img venobox vbox-item" href="{{ asset('lib/images/product/large-size/3.jpg') }}" data-gall="myGallery">
                                    <img src="{{ asset('lib/images/product/large-size/3.jpg') }}" alt="product image">
                                </a>
                            </div>
                            <div class="lg-image">
                                <a class="popup-img venobox vbox-item" href="{{ asset('lib/images/product/large-size/4.jpg') }}" data-gall="myGallery">
                                    <img src="{{ asset('lib/images/product/large-size/4.jpg') }}" alt="product image">
                                </a>
                            </div>
                            <div class="lg-image">
                                <a class="popup-img venobox vbox-item" href="{{ asset('lib/images/product/large-size/5.jpg') }}" data-gall="myGallery">
                                    <img src="{{ asset('lib/images/product/large-size/5.jpg') }}" alt="product image">
                                </a>
                            </div>
                            <div class="lg-image">
                                <a class="popup-img venobox vbox-item" href="{{ asset('lib/images/product/large-size/6.jpg') }}" data-gall="myGallery">
                                    <img src="{{ asset('lib/images/product/large-size/6.jpg') }}" alt="product image">
                                </a>
                            </div> --}}
                        </div>
                        <div class="product-details-thumbs slider-thumbs-1">                                        
                            <div class="sm-image"><img src="{{ asset('lib/images/product/small-size/1.jpg') }}" alt="product image thumb"></div>
                            {{-- <div class="sm-image"><img src="{{ asset('lib/images/product/small-size/2.jpg') }}" alt="product image thumb"></div>
                            <div class="sm-image"><img src="{{ asset('lib/images/product/small-size/3.jpg') }}" alt="product image thumb"></div>
                            <div class="sm-image"><img src="{{ asset('lib/images/product/small-size/4.jpg') }}" alt="product image thumb"></div>
                            <div class="sm-image"><img src="{{ asset('lib/images/product/small-size/5.jpg') }}" alt="product image thumb"></div>
                            <div class="sm-image"><img src="{{ asset('lib/images/product/small-size/6.jpg') }}" alt="product image thumb"></div> --}}
                        </div>
                    </div>
                    <!--// Product Details Left -->
                </div>
                    ...
                    <div class="product-details-view-content pt-60">
                        <div class="product-info">
                            ...
                            <div class="price-box pt-20">
                                <span class="new-price new-price-2">{{ number_format($product->gia_san_pham, 0, '', '.') }}đ</span>
                            </div>
                            <div class="product-desc">
                                <p>
                                    <ul>
                                        <li>Màn hình: 14.0 inch WUXGA</li>
                                        <li>CPU: Intel Core i5-1035G7</li>
                                        <li>RAM: 16GB DDR4</li>
                                        <li>�� cứng: 512GB PCIe</li>
                                        <li>Card màn hình: Intel Iris Plus Graphics 655</li>
                                        <li>Thiết kế: Full HD</li>
                                    </ul>
                                    </ul>
        ...
        <div class="tab-content">
            ...
            <div id="product-details" class="tab-pane" role="tabpanel">
                <div class="product-details-manufacturer">
                    <a href="#">
                        <img src="{{ asset('lib/images/product-details/1.jpg') }}" alt="Product Manufacturer Image">
                    </a>
                                        ...
                                        <div class="modal-inner-area row">
                                            <div class="col-lg-6">
                                               <div class="li-review-product">
                                                   <img src="{{ asset('lib/images/product/large-size/3.jpg') }}" alt="Li's Product">
                    ...
                    <div class="product-active owl-carousel">
                            ...
                            <div class="single-product-wrap">
                                <div class="product-image">
                                    <a href="single-product.html">
                                        <img src="{{ asset('lib/images/product/large-size/1.jpg') }}" alt="Li's Product Image">
                                    </a>
                        ...
                        {{-- <div class="col-lg-12">
                            ...
                            <div class="single-product-wrap">
                                <div class="product-image">
                                    <a href="single-product.html">
                                        <img src="{{ asset('lib/images/product/large-size/2.jpg') }}" alt="Li's Product Image">
                                    </a>
                                    <span class="sticker">New</span>
                                </div>
                                <div class="product_desc">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="single-product-wrap">
                                <div class="product-image">
                                    <a href="single-product.html">
                                        <img src="{{ asset('lib/images/product/large-size/3.jpg') }}" alt="Li's Product Image">
                                    </a>
                                    <span class="sticker">New</span>
                                </div>
                                <div class="product_desc">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="single-product-wrap">
                                <div class="product-image">
                                    <a href="single-product.html">
                                        <img src="{{ asset('lib/images/product/large-size/4.jpg') }}" alt="Li's Product Image">
                                    </a>
                                    <span class="sticker">New</span>
                                </div>
                                <div class="product_desc">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="single-product-wrap">
                                <div class="product-image">
                                    <a href="single-product.html">
                                        <img src="{{ asset('lib/images/product/large-size/5.jpg') }}" alt="Li's Product Image">
                                    </a>
                                    <span class="sticker">New</span>
                                </div>
                                <div class="product_desc">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="single-product-wrap">
                                <div class="product-image">
                                    <a href="single-product.html">
                                        <img src="{{ asset('lib/images/product/large-size/6.jpg') }}" alt="Li's Product Image">
                                    </a>
                                    <span class="sticker">New</span>
                                </div>
                                <div class="product_desc">
