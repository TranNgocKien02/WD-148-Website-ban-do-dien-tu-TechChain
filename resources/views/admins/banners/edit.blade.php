                ...
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    @error('tieu_de') is-invalid @enderror" value="{{old('tieu_de', $banner->tieu_de) }}"
                                    placeholder="Tiêu đề">
                                ...
                                <div class="mb-3">
                                    ...
                                    @error('mo_ta') is-invalid @enderror" value="{{ old('mo_ta', $banner->mo_ta) }}"
                                    placeholder="Mô tả">
                                ...
                                <div class="mb-3">
                                    ...
                                    @error('link') is-invalid @enderror" value="{{ old('link', $banner->link) }}"
                                ...
                                <div>
                                    ...
                                    <div class="col-sm-10 mb-3 d-flex gap-2 ">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="is_active" id="gridRadios1" value="1" {{ old('is_active', $banner->is_active) == true ? 'checked' : '' }}>
                                            <label class="form-check-label text-success" for="gridRadios1">
                                                Hiển thị
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="is_active" id="gridRadios2" value="0" {{ old('is_active', $banner->is_active) == false ? 'checked' : '' }}>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                @error('ngay_bat_dau') is-invalid @enderror" value="{{ old('ngay_bat_dau', $banner->ngay_bat_dau) }}"
                             ...
                             <div class="mb-3">
                                ...
                                @error('ngay_ket_thuc') is-invalid @enderror" value="{{ old('ngay_ket_thuc', $banner->ngay_ket_thuc) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <img src="{{ Storage::url($banner->anh) }}" id="anh_banner" alt="Ảnh Banner" style="width: 150px; display: block;" class="mt-2">
                                    @error('anh')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                                </div>
