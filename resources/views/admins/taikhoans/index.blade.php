                            ...
                            <table class="table table-striped mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $user->role }}</td>
                                        <td class="text-end">
                                            <a href="{{ route('admins.taikhoans.edit', $user->id) }}"><i class="mdi mdi-pencil text-muted fs-18 rounded-2 border p-1 me-1"></i></a>
                                            <form action="{{ route('admins.taikhoans.destroy', $user->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('Bạn có chắc chắn muốn xóa tài khoản này?')">
                                                @csrf
                                                @method('DELETE')
