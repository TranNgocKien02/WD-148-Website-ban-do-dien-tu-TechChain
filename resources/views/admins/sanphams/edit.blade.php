                    ...
                    <div class="collapse show" id="collapseProductInfo">
                        <div class="card-body">
                                    ...
                                    <div class="mb-3 w-100">
                                            ...
                                            <input type="number" class="form-control @error('so_luong') is-invalid @elseif(old('so_luong')) is-valid @enderror" name="so_luong"  value="{{ $sanPham->so_luong, old('so_luong') }}">
                                            @error('so_luong')
                                                <span class="invalid-feedback">{{$message}}</span>
                                            @enderror
                                        </div>
